...
import ShowContentPage from "./Views/CreateContentPage/ShowContentPage";
                ...
                <Switch>
                    ...
                    {props.auth.is_logged_in ?
                        ...
                        <>
                            ...
                            <Route exact path="/show-content" render={props => <Main {...props}><ShowContentPage {...props} /></Main>} />
                            <Route exact path="/create-content" render={props => <Main {...props}><CreateContentPage {...props} /></Main>} />
                            <Route exact path="/create-content/:id" render={props => <Main {...props}><CreateContentPage {...props} /></Main>} />
