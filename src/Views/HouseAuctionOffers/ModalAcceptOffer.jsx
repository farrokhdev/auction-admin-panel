...
function ModalAcceptOffer({visibleAcceptOffer , setVisibleAcceptOffer , openNotification}) {
    ...
    const handleCloseModal = () => {
        setVisibleAcceptOffer(false);
        window.location.reload()
    }

    const handleAcceptOffer = (state) => {
    ...
    return (
        <React.Fragment>
            <Modal
                ...
                visible={visibleAcceptOffer}
                onOk={() => setVisibleAcceptOffer(false)}
                onCancel={() => setVisibleAcceptOffer(false)}
                width={300}>
                            ...
                            <div className="d-block d-sm-flex mt-5">
                                <div className="col px-0">
                                    <div className="d-flex justify-content-center justify-content-sm-end ml-sm-3">
                                        <button onClick={()=>handleAcceptOffer(true)} className="btn-accept-offer">تایید درخواست</button>
                                    </div>
                                </div>
                                <div className="col px-0">
