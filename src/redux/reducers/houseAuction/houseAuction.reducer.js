...
const houseAuctionReducer = (state = initial_state, {type, payload = {}}) => {
    switch (type) {
        case types.SET_ADD_HOUSEAUCTION:
            return {
                ...state,
                ...payload,
                pending: true,
        ...
        case types.REMOVE_ADD_HOUSEAUCTION:
            return initial_state;
        default :
            return state;
    }
...
export default houseAuctionReducer;